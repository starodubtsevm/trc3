...
def read_config() -> list:
    ...
    return simulation_time, fs, fs2, f_rx, f_mod, threshold, xSignals, bins, window, delay
...
simulation_time, fs, fs2, f_rx, f_mod, threshold, xSignals, bins, window, delay = read_config()
