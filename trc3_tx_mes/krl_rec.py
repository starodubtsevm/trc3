...
class krl_receiver(object):
    def __init__(self, fc, fm):
        ...
        self.filt_ars125 = mean_filt(400)  # meaning for mesuariment
        self.filt_ars175 = mean_filt(400)  # meaning for mesuariment
        self.filt_ars225 = mean_filt(400)  # meaning for mesuariment
        self.filt_ars275 = mean_filt(400)  # meaning for mesuariment
        self.filt_ars325 = mean_filt(400)  # meaning for mesuariment
